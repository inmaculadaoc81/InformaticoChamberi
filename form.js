document.addEventListener('DOMContentLoaded',()=>{
 ...
 form.addEventListener('submit',async(e)=>{
  ...
  status.textContent='Enviando consulta…'; status.className='status sending';
  try{
   ...
   status.textContent='✓ Consulta enviada correctamente.'; status.className='status success';
   form.reset();
  }catch(err){
   ...
   else status.textContent='No se pudo enviar la consulta. También puedes escribirnos por WhatsApp.';
